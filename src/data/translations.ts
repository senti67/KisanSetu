export const TRANSLATIONS: Record<string, any> = {
  ...
  pa: {
    ...
    moistureBranch: "3. ਨਮੀ ਦੀ ਪੂਰਵ-ਜਾਂਚ",
    moistureDesc: "ਨਮੀ ਮੀਟਰ (Moisture Meter) ਦੀ ਰੀਡਿੰਗ ਦਰਜ ਕਰੋ",
    moistureMeterHint: "ਡਿਜੀਟਲ ਮੀਟਰ ਤੋਂ ਲਈ ਗਈ ਨਮੀ ਰੀਡਿੰਗ ਦਰਜ ਕਰੋ।",
    officialNotice: "ਅਧਿਕਾਰਤ ਨਮੀ ਪਰਖ ਮੰਡੀ ਕੇਂਦਰ 'ਤੇ ਕੀਤੀ ਜਾਂਦੀ ਹੈ।",
    moistureInputLabel: "ਨਮੀ ਮੀਟਰ ਰੀਡਿੰਗ (%)",
    passStatus: "ਪਾਸ (PASS)",
    passSub: "17.0% ਸੀਮਾ ਅੰਦਰ • ਕੋਈ ਕਟੌਤੀ ਨਹੀਂ",
    passAction: "ਮੰਡੀ ਵਿਕਰੀ ਲਈ ਤਿਆਰ",
    rejectStatus: "ਰੱਦ (REJECTED)",
    rejectSub: "ਧੁੱਪ ਵਿੱਚ ਸੁਕਾਉਣਾ ਜ਼ਰੂਰੀ • 17% ਤੋਂ ਵੱਧ",
    rejectAction: "ਫ਼ਸਲ ਸੁਕਾ ਕੇ ਦੁਬਾਰਾ ਚੈੱਕ ਕਰੋ",
    howItWorksTitle: "ਕਿਵੇਂ ਕੰਮ ਕਰਦਾ ਹੈ:",
    howItWorksStep1: "1. ਅਨਾਜ ਦਾ ਨਮੂਨਾ ਲਵੋ।",
    howItWorksStep2: "2. ਨਮੀ ਮੀਟਰ ਨਾਲ ਮਿਣੋ।",
    howItWorksStep3: "3. ਰੀਡਿੰਗ ਇੱਥੇ ਭਰੋ।",
    howItWorksStep4: "4. ਕਿਸਾਨਸੇਤੂ 17% ਸੀਮਾ ਪਰਖੇਗਾ।",
    ...
    testMoistureBtn: "ਨਮੀ ਰੀਡਿੰਗ ਚੈੱਕ ਕਰੋ",
